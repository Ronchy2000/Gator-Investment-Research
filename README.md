...
| 自 `2026-06-15` 起持续同步，支持图文与纯图片文章。 | 已通过双账号池归档 249 篇，并持续增量与历史补档。 | 支持分类、年份筛选和全文检索，历史内容冻结保存。 |
...
“像鳄鱼一样思考”显示共有 562 篇文章。单一微信读书登录账号最初只能枚举最近 99 篇；引入第二个登录账号并等待历史窗口逐步开放后，当前共归档 249 篇。公开中转的历史窗口会延迟开放和波动，系统会持续从断点补档，但不会把尚未实际下载的内容宣称为已归档。
