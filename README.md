...
| 自 `2026-06-15` 起持续同步，支持图文与纯图片文章。 | 已通过多账号池归档 448 篇，最早至 `2024-08-23`，并持续增量与历史补档。 | 支持分类、年份筛选和全文检索，历史内容冻结保存。 |
...
“像鳄鱼一样思考”显示共有 562 篇文章。单一微信读书登录账号最初只能枚举最近 99 篇；引入有序账号池并等待历史窗口逐步开放后，当前共归档 448 篇，尚有 114 篇等待更早分页开放。公开中转的历史窗口会延迟、波动且不连续，系统会在预计页数内循环补档，但不会把尚未实际下载的内容宣称为已归档。
