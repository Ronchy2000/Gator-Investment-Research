...
**鳄鱼派投资档案**是一个面向长期阅读的静态资料库。它把同一创作者运营的两个公众号放在一处：“获得信息差”负责每日信息整理，“像鳄鱼一样思考”负责每日市场复盘；同时保留旧站积累的 **913 篇公开研报**。截至 `2026-08-05` 已归档 **504 篇公众号文章**，正文和图片随站点一同保存，不必在聊天记录、收藏夹和失效链接之间反复寻找。
...
| 自 `2026-06-15` 起已归档 51 篇，支持图文与纯图片文章。 | 截至 `2026-08-05` 已归档 453 篇，最早至 `2024-08-20`，并持续增量与本地历史补档。 | 支持分类、年份筛选和全文检索，历史内容冻结保存。 |
