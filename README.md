...
| 自 `2026-06-15` 起持续同步，支持图文与纯图片文章。 | 已通过双账号池归档 199 篇，并持续增量与历史补档。 | 支持分类、年份筛选和全文检索，历史内容冻结保存。 |
...
“像鳄鱼一样思考”显示共有 562 篇文章。单一微信读书登录账号最初只能枚举最近 99 篇；引入第二个登录账号并按历史空页自动切换后，又补齐 100 篇，当前共归档 199 篇。系统会在以后追加账号时继续探测历史断点，但不会把接口尚未返回的内容宣称为已归档。
